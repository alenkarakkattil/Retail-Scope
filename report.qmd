---
title: "RetailScope: E-Commerce Sales Analysis"
...
This report presents a high-level analysis of the Brazilian e-commerce dataset from Olist. All data loading and cleaning is performed by the custom `RetailScope` R package, ensuring the analysis is fully reproducible.
...
# Load and clean data using our package's functions
...
Here are the core business metrics from all delivered orders in the dataset.
...
#### Total Revenue
**`r paste0("₹", round(total_revenue / 1000000, 2), "M")`**
...
The interactive chart below shows the total revenue generated each month. It reveals a clear seasonal pattern and a strong overall growth trend over the two-year period.
...
This analysis highlights the strong growth and regional performance of the business. By leveraging the `RetailScope` package, this Quarto document serves as a fully reproducible and shareable artifact of our key findings.
